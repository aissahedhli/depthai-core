...
std::shared_ptr<ADatatype> XLinkInHost::readData(const XLinkStream& stream) {
...
std::shared_ptr<ADatatype> XLinkInHost::parsePacketizedData(const std::shared_ptr<PacketizedData>& packetizedData, const XLinkStream& stream) {
...
void XLinkInHost::parseMessageGroup(const std::shared_ptr<MessageGroup>& messageGroup, const XLinkStream& stream) {
